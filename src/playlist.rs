...
impl Playlist {
    ...
    fn add_text_column(treeview: &TreeView,
                       title: &str,
                       column: i32) {
        ...
        let _ = treeview.append_column(&view_column);
    }

    fn add_pixbuf_column(treeview: &TreeView,
                         column: i32,
